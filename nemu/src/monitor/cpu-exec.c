...
#define LOG_MAX (4096 * 2048)

#define START_DEBUG_PC 0x3014994
#define END_DEBUG_PC 0x3014b7e
...
void cpu_exec(uint64_t n) {
  ...
  //if (cpu.pc >= START_DEBUG_PC && cpu.pc <= END_DEBUG_PC)
