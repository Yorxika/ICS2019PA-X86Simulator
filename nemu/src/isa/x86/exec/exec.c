...
//refer from one-byte Opcode Map
//http://www.logix.cz/michal/doc/i386/app-a.htm

//in opcode map 
//e means reg/mem , addr decided by modrm rm 
//g mean reg , addr decided by modrm reg
//i mean imm , imm is opcode
//m mean mem , addr decided by modrm rm
...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x50 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),   //push eax ecx edx ebx
  /* 0x54 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),   //push esp ebp esi edi
  ...
  /* 0x70 */	IDEXW(J,jcc,1), IDEXW(J,jcc,1), IDEXW(J,jcc,1), IDEXW(J,jcc,1), // Short displacement jump of condition (Jb) 
...
/*2 byte_opcode_table */
  ...
  /* 0x80 */	IDEX(J,jcc),IDEX(J,jcc),IDEX(J,jcc),IDEX(J,jcc),   //Long-displacement jump on condition (Jv)    
