...
static inline void rtl_sext(rtlreg_t* dest, const rtlreg_t* src1, int width) {
  ...
  //TODO();
  int ans = *src1;
  *dest = (ans << (32 - width * 8)) >> (32 - width * 8);
}
...
static inline void rtl_my_sar(rtlreg_t *dest, rtlreg_t *src, int times, int width) {
  int8_t val;
  int16_t val_2;
  int32_t val_3;
  switch (width) {
...
static inline void rtl_rol(rtlreg_t *dest, rtlreg_t *src, int times, int width) {
  ...
  switch (width) {
    ...
    case 2:
      val_2 = *((uint16_t *)src);
      *dest = (val_2 << times) | (val_2 >> (16 - times));
      break;
    case 4:
      val_3 = *((uint32_t *)src);
      *dest = (val_3 << times) | (val_3 >> (32 - times));
      break;
    default:
      Assert(0, "Illegal width!");
  }
